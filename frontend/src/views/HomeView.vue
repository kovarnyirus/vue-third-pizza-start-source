        ...
        <div class="content__dough">
          <div class="sheet">
            ...
            <div class="sheet__content dough">
              <label v-for="doughItem in doughItems" :key="doughItem.id" class="dough__input dough__input--light"
                :class="`dough__input--${doughItem.value}`">
                <input type="radio" name="dought" :value="doughItem.value" class="visually-hidden" checked>
                <b>{{ doughItem.name }}</b>
        ...
        <div class="content__diameter">
          <div class="sheet">
            ...
            <div class="sheet__content diameter">
              <label v-for="sizeItem in sizeItems" :key="sizeItem.id" class="diameter__input"
                :class="`diameter__input--${sizeItem.value}`">
                <input type="radio" name="diameter" :value="sizeItem.value" class="visually-hidden">
          ...
          <div class="sheet">
            ...
            <div class="sheet__content ingredients">
              <div class="ingredients__sauce">
                <p>Основной соус:</p>
                <label v-for="sauceItem in sauceItems" :key="sauceItem.id" class="radio ingredients__input">
                  <input type="radio" name="sauce" :value="sauceItem.value" checked>
              ...
              <div class="ingredients__filling">
                ...
                <ul class="ingredients__list">
                  <li v-for="ingredientItem of ingredientItems" :key="ingredientItem.id" class="ingredients__item">
                    <span class="filling" :class="`filling--${ingredientItem.value}`">{{ ingredientItem.name }}</span>
